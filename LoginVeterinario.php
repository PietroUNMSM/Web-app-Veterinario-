...
$nombre = $_REQUEST[ 'nombre_veterinario_reg' ];
$password = $_REQUEST[ 'pass_veterinario_reg' ];
...
$sql = "SELECT id, dni, nombre, correo, password FROM veterinarios WHERE nombre = ?";
...
if($stmt = mysqli_prepare($conn, $sql)){
    ...
    if(mysqli_stmt_execute($stmt)){
        ...
        if(mysqli_stmt_num_rows($stmt) == 1){                    
            ...
            mysqli_stmt_bind_result($stmt, $id, $dni, $username,  $correo, $hashed_password);
